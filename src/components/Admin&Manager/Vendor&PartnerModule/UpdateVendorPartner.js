...
const UpdateContact = () => {
  ...
  const contactDetails=JSON.parse(localStorage.getItem('vendorRow'))
  ...
  const submitHandler = (e) => {
    e.preventDefault()
    try {
      api.put(`/app/vendorpartners/updateVendorPartner/${contactDetails?.vendorPartnerId}`, contactInfo)
        .then(res => {
  ...
  useEffect(() => {
    api.get(`/app/vendorpartners/${contactDetails?.vendorPartnerId}`)
      .then(res => {
        // console.log(res.data);
      ...
      <div className="row justify-content-center">
        <div className="col-md-10">
          <div className="card mt-3">
            <div className="card-header"><h2 className="text-info">Update Vendor/Partner</h2></div>
                ...
                <div className="row">
                  ...
                  <div className="col-12 mt-4">
                    <div className="input-group d-flex justify-content-center">
                      <button type="submit" style={{marginRight:'20px',marginBottom:'10px',width:'80px'}} value={'Update'}>Submit</button>
