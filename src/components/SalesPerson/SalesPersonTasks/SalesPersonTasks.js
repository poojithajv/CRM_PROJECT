...
import '../../Admin&Manager/TaskModule/Task.css'
...
function SalesPersonTasks() {
  ...
  console.log(data)
    ...
    const onRowHandleClick=(params)=>{
      ...
      setDat(params?.row)
      console.log(params?.row?.contactSub?.contactId?.contactId)
      localStorage.setItem('contactId',params?.row?.contactSub?.contactId?.contactId)
      setTimeout(() => {
        console.log('hi')
